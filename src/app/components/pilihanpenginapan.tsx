              ...
              <LayoutProvider>
                <Scroller fadeColor="transparent">
                  <div className="flex flex-row gap-6 px-4 ">
                    {/* card 1 */}
                    <div className="border-1 border-[var(--primary)] rounded-[30px] overflow-hidden w-full sm:w-[300px] md:w-[330px] xl:w-[400px]">
                      {/* Carousel */}
                      ...
                      <div className="bg-[var(--bgcard)] text-[var(--primary)] border-1 border-[var(--primary)] p-4 rounded-[30px]">
                        ...
                        <div className="flex items-center justify-between gap-1">
                          <p className="text-base lg:text-lg xl:text-xl text-left font-semibold">Rp1.500.000/malam</p>
                          <button
                    ...
                    <div className="border-1 border-[var(--primary)] rounded-[30px] overflow-hidden w-full sm:w-[300px] md:w-[330px] xl:w-[400px]">
                      ...
                      <div className="bg-[var(--bgcard)] text-[var(--primary)] border-1 border-[var(--primary)] p-4 rounded-[30px]">
                        ...
                        <div className="flex items-center justify-between gap-1">
                          <p className="text-base lg:text-lg xl:text-xl text-left font-semibold">Rp750.000/malam</p>
                          <button
                            onClick={handleBookNow}
                            className="flex items-center justify-center px-2 gap-2 xl:gap-4 bg-[var(--primary)] text-[var(--secondary)] rounded-2xl hover:bg-[var(--primaryhover)] transition  xl:px-4 md:py-2 font-semibold text-base xl:text-lg"
                          >
                    ...
                    <div className="border-1 border-[var(--primary)] rounded-[30px] overflow-hidden w-full sm:w-[300px] md:w-[330px] xl:w-[400px]">
                      ...
                      {/* Section biru + konten */}
                      <div className="bg-[var(--bgcard)] text-[var(--primary)] border-1 border-[var(--primary)] p-4 rounded-[30px]">
                        <h2 className="text-base md:text-lg lg:text-xl xl:text-2xl underline font-semibold mb-3 md:mb-4 xl:mb-5 text-left">Villa Reguler Tipe B</h2>

                        <div className="grid grid-cols-3 gap-3 md:gap-4 xl:gap-6 items-center justify-center justify-items-left text-xs md:text-sm xl:text-base mb-4 md:mb-7 xl:mb-5">
                          <div className="flex flex-row items-center gap-1">
                            <span>
                              <Landmark className="size-3 md:size-5 xl:size-6" />
                            </span>
                        ...
                        <div className="flex items-center justify-between gap-1">
                          <p className="text-base lg:text-lg xl:text-xl text-left font-semibold">Rp600.000/malam</p>
                          <button
                            onClick={handleBookNow}
                            className="flex items-center justify-center px-2 gap-2 xl:gap-4 bg-[var(--primary)] text-[var(--secondary)] rounded-2xl hover:bg-[var(--primaryhover)] transition  xl:px-4 md:py-2 font-semibold text-base xl:text-lg"
                          >
                    ...
                    <div className="border-1 border-[var(--primary)] rounded-[30px] overflow-hidden w-full sm:w-[300px] md:w-[330px] xl:w-[400px]">
                      ...
                      {/* Section biru + konten */}
                      <div className="bg-[var(--bgcard)] text-[var(--primary)] border-1 border-[var(--primary)] p-4 rounded-[30px]">
                        <h2 className="text-base md:text-lg lg:text-xl xl:text-2xl underline font-semibold mb-5 xl:mb-5 text-left">Villa Reguler Tipe C</h2>
                        ...
                        <div className="flex items-center justify-between gap-1">
                          <p className="text-base lg:text-lg xl:text-xl text-left font-semibold">Rp500.000/malam</p>
                          <button
                            onClick={handleBookNow}
                            className="flex items-center justify-center px-2 gap-2 xl:gap-4 bg-[var(--primary)] text-[var(--secondary)] rounded-2xl hover:bg-[var(--primaryhover)] transition  xl:px-4 md:py-2 font-semibold text-base xl:text-lg"
                          >
                    ...
                    <div className="border-1 border-[var(--primary)] rounded-[30px] overflow-hidden w-full sm:w-[300px] md:w-[330px] xl:w-[400px]">
                      ...
                      {/* Section biru + konten */}
                      <div className="bg-[var(--bgcard)] text-[var(--primary)] border-1 border-[var(--primary)] p-4 rounded-[30px]">
                        <h2 className="text-base md:text-lg lg:text-xl xl:text-2xl underline font-semibold mb-3 xl:mb-2 text-left">Homestay</h2>
